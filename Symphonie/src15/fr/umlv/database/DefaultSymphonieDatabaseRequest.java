...
import fr.umlv.database.request.InsertStudentNoteFromCourseAndIntitulate;
import fr.umlv.database.request.ListCoursesIntitulateFromCourse;
import fr.umlv.database.request.admin.DeleteCourse;
import fr.umlv.database.request.GetListStudentNoteFromCourseAndIntitulate;
import fr.umlv.database.request.ListStudent;
import fr.umlv.database.request.ListCourses;
import fr.umlv.database.request.ListCoursesIntitulate;
import fr.umlv.database.request.SetCommentFromStudent;
import fr.umlv.database.request.SetStudentNoteFromCourseAndIntitulate;
import fr.umlv.database.request.StudentNoteFromCourseAndIntitulate;
import fr.umlv.database.request.GetCommentFromStudent;
import fr.umlv.database.request.admin.ChangeCourseName;
import fr.umlv.database.request.admin.ChangeIntitulateCoefficient;
import fr.umlv.database.request.admin.ChangeIntitulateLabel;
import fr.umlv.database.request.admin.ChangeStudentName;
import fr.umlv.database.request.admin.DeleteIntitulate;
import fr.umlv.database.request.admin.DeleteStudent;
import fr.umlv.database.request.admin.InsertCourse;
import fr.umlv.database.request.admin.InsertIntitulate;
import fr.umlv.database.request.admin.InsertStudent;
/**
 * @author jraselin
 *
