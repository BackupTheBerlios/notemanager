 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ItemEditRedo extends MenuItemCache implements MenuItem {

	private final JMenuItem item;
	
	public ItemEditRedo() throws SAXException,IOException,ParserConfigurationException{
		item = new JMenuItem(getMap().get("editRedo"));
	 ...
	 */
	public void setText() {
		item.setText(getMap().get("editRedo"));		
	}
