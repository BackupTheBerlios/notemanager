 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ItemEditSelect extends MenuItemCache implements MenuItem {

	private final JMenuItem item;
	
	public ItemEditSelect() throws SAXException,IOException,ParserConfigurationException{
		item = new JMenuItem(getMap().get("editSelectAll"));
	...
	public void register() {
		getRegistry().put("editSelectAll",this);				
	}
	 ...
	 */
	public void setText() {
		item.setText(getMap().get("editSelectAll"));		
	}
