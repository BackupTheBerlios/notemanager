 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ItemFileExport extends MenuItemCache implements MenuItem {

	private final JMenuItem item;
	
	public ItemFileExport() throws SAXException,IOException,ParserConfigurationException{
		item = new JMenuItem(getMap().get("fileExport"));
	...
	public void register() {
		getRegistry().put("fileExport",this);				
	}
	 ...
	 */
	public void setText() {
		item.setText(getMap().get("fileExport"));		
	}
