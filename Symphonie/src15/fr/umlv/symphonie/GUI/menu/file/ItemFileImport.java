 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ItemFileImport extends MenuItemCache implements MenuItem {

	private final JMenuItem item;
	
	public ItemFileImport() throws SAXException,IOException,ParserConfigurationException{
		item = new JMenuItem(getMap().get("fileImport"));
	...
	public void register() {
		getRegistry().put("fileImport",this);				
	}
	 ...
	 */
	public void setText() {
		item.setText(getMap().get("fileImport"));		
	}
