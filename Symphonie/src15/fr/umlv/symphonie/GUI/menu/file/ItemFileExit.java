 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ItemFileExit extends MenuItemCache implements MenuItem {

	private final JMenuItem item;
	
	public ItemFileExit() throws SAXException,IOException,ParserConfigurationException{
		item = new JMenuItem(getMap().get("fileExit"));
	 ...
	 */
	public void setText() {
		item.setText(getMap().get("fileExit"));		
	}
